        ...
        *,
        ...
        lines.extend(
            [
                ...
                "- `mcp__evidence-tools__evidence_fact_proposal(proposal_id?, iteration?, candidate_id?, include_outcome?)`",
                "",
                "Evidence-link tools:",
                ...
                "- `mcp__evidence-tools__evidence_link_explain_proposal(proposal_id?, iteration?, candidate_id?, include_diff?, include_examples?, include_retrieval?, max_examples?)`",
