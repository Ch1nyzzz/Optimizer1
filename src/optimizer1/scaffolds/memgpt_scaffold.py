...
from optimizer1.scaffolds.bm25_scaffold import SimpleBM25Okapi
from optimizer1.utils.text import estimate_tokens, tokenize
...
def _compile_memory_metadata(
    *,
    ...
    lines = [
        "<memory_metadata>",
        f"- AGENT_ID: optimizer1-{example.sample_id}",
